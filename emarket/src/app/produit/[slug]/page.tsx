  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        {/* Product info */}
        <div>
          <p className="text-sm text-gray-500 mb-2">{product.categorie.nom}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <a
              ...
              className="flex-1 border-2 border-green-500 text-green-600 py-3 px-6 rounded-lg font-semibold hover:bg-green-50 transition-colors text-center"
            >
